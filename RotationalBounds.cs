...
public struct RotationalBounds
{
    ...
    {
        return OverlapUtilities3D.RectangularPrismOverlaps(center, extents, rotation, b.center, b.extents, b.rotation);
    }
    
    /// <summary>
    /// Return the smallest axis-aligned bounds that encapsulates the RotationalBounds
    /// </summary>
    /// <returns></returns>
